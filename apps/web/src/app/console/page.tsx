              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-[13px] text-ink-inverted/50">
                    {account.slug} · {account.memberCount} people · {account.propertyCount} websites
                    · {account.conversationCount} conversations
                  </p>
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/60 p-6">
          <div className="w-full max-w-md rounded-[var(--radius-card)] border border-ink-inverted/20 bg-ink p-5">
            ...
            <textarea
              ...
              placeholder="Repeated spam complaints from visitors on acme.example"
