...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of service" updated="9 September 2026">
      ...
      <Clause title="6. The AI assistant">
        <p>
          Where your plan includes it, you may switch on an AI assistant that replies to visitors
          from the content you have published and the facts you have entered. Its replies are
          generated automatically, are labelled as such to the visitor, and may be wrong or
          incomplete; you are responsible for the content you give it and for reviewing what it
          says on your behalf. When our own model cannot answer, the reply may be generated by a
          third-party provider as described in the privacy policy. Do not enter anything
          confidential in the assistant's instructions or key facts: they are, by design, things
          the assistant may say to anyone.
        </p>
      </Clause>
